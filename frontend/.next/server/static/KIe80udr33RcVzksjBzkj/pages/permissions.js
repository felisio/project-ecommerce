...
/* harmony import */ var _components_styles_Form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9);
/* harmony import */ var _components_ErrorMessage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(6);
/* harmony import */ var _User__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(5);
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_2__["Mutation"], {
        ...
        var loading = _ref.loading,
            error = _ref.error;
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_styles_Form__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"], {
          method: "post",
          onSubmit:
          /*#__PURE__*/
          function () {
          ...
          disabled: loading,
          "aria-busy": loading
        }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("h2", null, "Sign into your account"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_ErrorMessage__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"], {
          error: error
...
/* harmony import */ var _User__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5);
...
var PleaseSignIn = function PleaseSignIn(props) {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_1__["Query"], {
    ...
    if (!data.me) {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, "Please Sign in!"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Signin__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"], null));
    }
...
// CONCATENATED MODULE: ./components/PermissionsItem.js
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var UPDATE_PERMISSION_MUTATIONS = Object(external_apollo_boost_["gql"])(_templateObject());

var PermissionsItem_PermissionsItem =
/*#__PURE__*/
function (_React$Component) {
  _inherits(PermissionsItem, _React$Component);
  ...
  function PermissionsItem() {
    ...
    _classCallCheck(this, PermissionsItem);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(PermissionsItem)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this), "state", {
      permissions: _this.props.user.permissions
    });

    _defineProperty(_assertThisInitialized(_this), "handlePermissionChange", function (e, updatePermissionsMutation) {
      var checkbox = e.target;

      var updatePermissions = _toConsumableArray(_this.state.permissions);

      if (checkbox.checked) {
        updatePermissions.push(checkbox.value);
      } else {
        updatePermissions = updatePermissions.filter(function (item) {
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_apollo_["Mutation"], {
        ...
        return external_react_default.a.createElement("tr", {
          key: user.id
        }, external_react_default.a.createElement("td", null, user.name), external_react_default.a.createElement("td", null, user.email), possiblePermissions.map(function (permission) {
...
/* harmony default export */ var components_PermissionsItem = (PermissionsItem_PermissionsItem);
// CONCATENATED MODULE: ./components/Permissions.js


function Permissions_templateObject() {
  var data = Permissions_taggedTemplateLiteral(["\nquery ALL_USERS_QUERY {\n  users {\n    id\n    name\n    email\n    permissions\n  }\n}\n"]);

  Permissions_templateObject = function _templateObject() {
    return data;
  };
...
function Permissions_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var ALL_USERS_QUERY = external_graphql_tag_default()(Permissions_templateObject());
  ...
  return external_react_default.a.createElement(external_react_apollo_["Query"], {
    ...
    if (data.users) {
      return external_react_default.a.createElement("div", null, external_react_default.a.createElement("h2", null, "Manage Permissions"), external_react_default.a.createElement(styles_Table, null, external_react_default.a.createElement("thead", null, external_react_default.a.createElement("tr", null, external_react_default.a.createElement("th", null, "Name"), external_react_default.a.createElement("th", null, "Email"), possiblePermissions.map(function (permission) {
        ...
        return external_react_default.a.createElement(components_PermissionsItem, {
          key: user.id,
          user: user
        });
      }))));
